...
ps_gamedefs needs to be edited to match your client and the psmagent.dll needs to be installed on ps_gamelog

psmagent can be removed by deleting the dbo.command procedure and the psmagnet assembly in the ps_gamelog database

comment out or remove the leader resurrect in grb procedure in dbo.usp_Insert_Action_Log_E if you don't use the psmagent
